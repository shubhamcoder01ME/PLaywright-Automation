...
class IntelligencePage {
  constructor(page) {
    ...
    this.locators = {
      ...
      applicationReportsMenu: this.page.locator("//body[1]/div[1]/div[1]/span[1]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/ul[1]/div[10]/div[2]/a[5]/div[1]/li[1]"),
      ...
      applicationReportsGearOptions: this.page.locator("//body[1]/div[1]/div[1]/span[1]/div[1]/div[2]/div[3]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/button[1]"),
      exportButtonInPage: this.page.locator("//button[normalize-space()='Export']"),
      accessAnalysisMenu: this.page.locator("//body[1]/div[1]/div[1]/span[1]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/ul[1]/div[10]/div[2]/a[6]/div[1]/li[1]"),
  ...
  async clickIdentityMindmapMenu() {
    await this.page.locator("//body[1]/div[1]/div[1]/span[1]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/ul[1]/div[10]/div[2]/a[1]/div[1]/li[1]").click();
  }

  async clickApplicationMindmapMenu() {
    await this.page.locator("//body[1]/div[1]/div[1]/span[1]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/ul[1]/div[10]/div[2]/a[2]/div[1]/li[1]").click();
  }
  ...
  async selectFirstOptionFromDropdown(dropdownName) { 
    const option = this.page.locator("//a[normalize-space()='Admin Admin (admin@securends.com)']");
    await option.first().click();
  }

  async verifyOptionsInPage(pageName) {
    await this.page.locator("//div[contains(@class,'treeSpots')]").waitFor({ state: 'visible', timeout: 60000 });
  }
  ...
  async verifyExportButtonInPage() {
    await this.locators.exportButtonInPage.waitFor();
  }
  ...
  async verifyApplicationReportsGearOptions() {
    // Wait until table or container is visible
    await this.locators.applicationReportsGearOptions.waitFor({ state: 'visible', timeout: 60000 });
    await this.locators.applicationReportsGearOptions.click();
  }
